...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  if (topic2  == "m/r1") {
    ...
    if((char)payload[0] == '0'){
      digitalWrite(D3, 0);
      digitalWrite(D4, 0);
      client.publish("m/r1", "0");
      client.publish("m/r2", "0"); 
    }
  }
  else{
    if((char)payload[0] == '0'){
      digitalWrite(D3, 1);
      digitalWrite(D4, 1);
      client.publish("m/r1", "1");
      client.publish("m/r2", "1"); 
    }
  }
...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    if (client.connect(clientId.c_str())) {
      ...
      client.publish("Seo123", "hello !");///////////////////////////////////////////////////////
      // ... and resubscribe
      client.subscribe("m/r1");/////////////////////////////////////////////////////////////////////
      client.subscribe("m/r2");/////////////////////////////////////////////////////////////////////
      client.subscribe("m/a");/////////////////////////////////////////////////////////////////////            
    } else {
